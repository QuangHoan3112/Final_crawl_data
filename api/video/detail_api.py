...
def get_video_details_by_id(video_id: str, headers, base_url="https://tiktok-scrapper-videos-music-challenges-downloader.p.rapidapi.com/video/id/{}") -> Video:
    ...
    try:
        ...
        # status 200 OK
        data = response.json()
        video = Video(data['data']['video_info'])
        return video
